                ...
                <div class="onboarding-wrapper mt-5">
                    ...
                    <div class="onboarding-steps-indicator mb-4">
                        ...
                        <div class="row no-gutters">
                            ...
                            $steps_part1 = [
                                0 => __('onboarding.personal_info'),
                                1 => __('onboarding.physical_attributes'),
                                2 => __('onboarding.nationality_city_residence'),
                                3 => __('onboarding.final_details'),
                                4 => __('onboarding.terms_conditions'),
                            ];
                            @endphp
                            @foreach ($steps_part1 as $index => $step)
                        ...
                        <div class="card-body p-lg-5">
                            <form id="onboarding-form" method="POST" action="{{ route('user.profile.update') }}"
                                ...
                                <div class="onboarding-steps">
                                    ...
                                    <!-- Step 2: Nationality, City, Residence -->
                                    ...
                                    <!-- Step 3: Final Details (Car, Financial, Guardian Contact) -->
