                                    ...
                                    <div class="onboarding-step" id="step-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <select name="zodiac_sign_id" class="form-control rounded-pill"
                                                required>
                                                <option value="">
                                                    {{ __('onboarding.select_zodiac_sign') }}
                                                </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="hair_color_id" class="form-control rounded-pill"
                                            required>
                                            <option value="">
                                                {{ __('onboarding.select_hair_color') }}
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="skin_color_id" class="form-control rounded-pill"
                                            required>
                                            <option value="">
                                                {{ __('onboarding.select_skin_color') }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="religiosity_levels" name="religiosity_level_id"
                                            class="form-control rounded-pill" required>
                                            <option value="">
                                                {{ __('onboarding.select_religiosity') }}
                                            </option>
                                ...
                                <div class="col-md-4 position-level-wrapper " style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="position_level_id" class="form-control rounded-pill"
                                            required>
                                            <option value="">
                                                {{ __('onboarding.select_position_level') }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="educational_level_id"
                                            class="form-control rounded-pill" required>
                                            <option value="">
                                                {{ __('onboarding.select_educational_level') }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="specialization_id" class="form-control rounded-pill"
                                            required>
                                            <option value="">
                                                {{ __('onboarding.select_specialization') }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="sports_activity_id"
                                            class="form-control rounded-pill" required>
                                            <option value="">
                                                {{ __('onboarding.select_sports_activity') }}
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="drinking_status_id"
                                            class="form-control rounded-pill" required>
                                            <option value="">
                                                {{ __('onboarding.select_drinking_status') }}
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="marital_status_id" class="form-control rounded-pill"
                                            required>
                                            <option value="">
                                                {{ __('onboarding.select_marital_status') }}
                                            </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="marriage_budget_id"
                                    class="form-control rounded-pill" required>
                                    <option value="">
                                        {{ __('onboarding.select_marriage_budget') }}
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="housing_status_id"
                                    class="form-control rounded-pill" required>
                                    <option value="">
                                        {{ __('onboarding.select_housing_status') }}
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="nationality_id" class="form-control rounded-pill"
                                    required>
                                    <option value="">
                                        {{ __('onboarding.select_nationality') }}
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="financial_status_id"
                                    class="form-control rounded-pill" required>
                                    <option value="">
                                        {{ __('onboarding.select_financial_status') }}
                                    </option>
...
<script>
    ...
    $('#religion_id').on('change', function() {
        ...
        $('#religiosity_levels')
            .empty()
            .append('<option value="">{{ __('
                onboarding.select_religiosity ') }}</option>');
    ...
    $(document).ready(function() {
        ...
        $('#city_id').on('change', function() {
            ...
            $('#city_location_id')
                .empty()
                .append('<option value="">{{ __('
                    onboarding.city_location ') }}</option>');
...
@section('section')
    ...
    @php
        $locale = app()->getLocale();
        $stepsOnThisPage = [2, 3]; // Steps included in this blade
    @endphp
    <style>
         [dir="rtl"] .disclaimer-section .form-check-label strong {
        margin-right: 20px;
    ...
    #final-submit-button .btn-loader {
        ...
        /* Copy all the CSS from first blade or include it separately */
        [dir="rtl"] .disclaimer-section .form-check-label strong {
            margin-right: 20px;
            display: inline-block;
        }
        ...
        @media (max-width: 768px) {
            .onboarding-steps-indicator .row.no-gutters {
                flex-wrap: nowrap;
                overflow-x: auto;
                padding-bottom: 10px;
            }
                ...
                <div class="col-lg-12">
                    <div class="onboarding-wrapper mt-5">
                        <div class="onboarding-steps-indicator mb-4">
                            ...
                            <div class="row no-gutters">
                                 @php
                            // Define step titles for Part 1
                            $stepTitlesOnThisPage = [
                                        2 => __('onboarding.employment_lifestyle'),
                                        3 => __('onboarding.family_housing'),
                                    ];
                            @endphp
                            @foreach ($stepTitlesOnThisPage as $index => $step)
                            <div class="col step-indicator {{ $index == 2 ? 'active' : '' }}"
                                data-step="{{ $index }}">
                                <div class="step-number">{{ array_search($index, array_keys($stepTitlesOnThisPage)) + 1 }}</div>
                                <div class="step-name d-none d-md-block">{{ $step }}</div>
                            </div>
                            @endforeach
                        ...
                        <div class="card rounded-lg shadow-lg onboarding-card">
                            <div class="card-body p-lg-5">
                                <form id="onboarding-form-part2" method="POST" action="{{ route('user.profile.update.part2') }}"
                                    ...
                                    <div class="onboarding-steps">
                                        <!-- Step 2: Employment and Lifestyle -->
                                        <div class="onboarding-step" id="step-2" style="display:block;">
                                            <h2 class="card-title text-center mb-4 section-title">
                                                {{ __('onboarding.employment_lifestyle') }}
                                            </h2>
                                            ...
                                            <div class="onboarding-navigation d-flex justify-content-between mt-4">
                                                <button type="button" class="btn btn-secondary rounded-pill prev-step" style="visibility: hidden;">
                                                ...
                                                <button type="button" class="btn btn-primary rounded-pill next-step" disabled>
                                                    {{ __('onboarding.next') }}
                                                    <i class="fas fa-arrow-{{ $locale === 'ar' ? 'left' : 'right' }} ml-2"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="onboarding-step" id="step-3" style="display:none;">
                                            ...
                                            <div class="onboarding-navigation d-flex justify-content-between mt-4">
                                                ...
                                                <button type="submit" class="btn btn-success rounded-pill submit-part2">
    ...
    <script>
        // Assume user gender is available from a hidden field or global variable.
        var userGender = "{{ old('gender', auth()->user()->gender ?? '') }}";
        var stepsOnThisPage = [2, 3]; // Steps included in this blade
        ...
        function saveCurrentFormToLocalStorage() {
            ...
            // Save all inputs, selects, textareas from THIS form
            ...
            let existingData = sessionStorage.getItem(LS_KEY_DATA);
            let combinedData = existingData ? JSON.parse(existingData) : {};

            // Merge new data with existing
            Object.assign(combinedData, data);

            // Save back to storage
            sessionStorage.setItem(LS_KEY_DATA, JSON.stringify(combinedData));
        }
        ...
        function loadSavedStep() {
            let saved = sessionStorage.getItem(LS_KEY_STEP);
            if (!saved) return 2; // Default to step 2 for this blade

            saved = parseInt(saved);

            // Ensure the saved step is within our page's steps
            if (!stepsOnThisPage.includes(saved)) {
                saved = 2; // Default to first step of this blade
            }
        ...
        function validateField(field) {
            ...
            // If not "touched" yet, skip validation
            if (!touched) {
                return false;
            }
            ...
            // Field-specific "required" overrides for THIS blade
            if (
                ['specialization_id', 'job_title_id', 'drinking_status_id'].includes(fieldName) &&
                value === ''
            ) {
            ...
            // Smoking tools conditional validation (specific to step 2)
            if (fieldId === 'smoking_tools') {
                const smokingStatus = $('select[name="smoking_status"]').val();
                if (smokingStatus === '1' && value.length === 0) {
                    errorSpan.text("{{ __('onboarding.required') }}");
        ...
        // Apply required rules only to visible step
        function applyStepRequiredRules(step) {
        ...
        function updateStepIndicator(currentIndex) {
            $('.step-indicator').each(function() {
                ...
                if (stepIndex < currentIndex) {
                    $stepNumber.css('background-color', '#FF3494');
                    $(this).addClass('completed').removeClass('active');
                } else if (stepIndex === currentIndex) {
                    $stepNumber.css('background-color', '#7D4196').css('opacity', '1');
                    $(this).addClass('active').removeClass('completed');
                } else {
                    $stepNumber.css('background-color', '#f1f1f1');
        ...
        $(document).ready(function() {
            ...
            updateNextButton($(`#step-${startingStep}`));
            ...
            $('#onboarding-form-part2').on('submit', function(e) {
                ...
                $('.submit-part2').prop('disabled', true).html('<span class="spinner-border spinner-border-sm mr-2" role="status" aria-hidden="true"></span> {{ __("onboarding.submitting") }}');

                // Submit the form
                this.submit();
            });

            // Mobile touch fix for textareas
            if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) {
                $('textarea').on('touchstart', function() {
                    $(this).focus();
                });
