                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex flex-row mb-3">
                                                        <div class="pl-3 pt-2 pr-2 pb-2">
                                                            <strong>{{ __('profile.Nationality') }}:</strong> {{ $userPreferences['preferred_nationality'] }}
                                                        </div>
                                                    </div>

                                                    <div class="d-flex flex-row mb-3">
                                                        <div class="pl-3 pt-2 pr-2 pb-2">
                                                            <strong>{{ __('profile.Age') }}:</strong> {{ $userPreferences['preferred_age_min'] . " - " . $userPreferences['preferred_age_max'] }}
                                                        </div>
                                                    </div>
