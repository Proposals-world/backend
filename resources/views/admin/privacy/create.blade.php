...
@section('title', isset($policy) ? 'Edit Privacy Policy' : 'Add Privacy Policy')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box justify-content-between d-flex align-items-md-center flex-md-row flex-column">
                    <h4 class="page-title">{{ isset($policy) ? 'Edit Privacy Policy' : 'Add Privacy Policy' }}</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('privacy.index') }}">Admin</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- ✅ Form --}}
                        @if (isset($policy))
                            <form action="{{ route('privacy.update', $policy->id) }}" id="privacyForm" method="POST">
                                @method('PUT')
                        @else
                            <form action="{{ route('privacy.store') }}" id="privacyForm" method="POST">
                        @endif
                            @csrf
