                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="index.html" role="button">
                            <i class="ri-dashboard-2-fill"></i>Dashboards
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-chartjs" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Chartjs <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-chartjs">
                                    <a href="charts-chartjs-area.html" class="dropdown-item">Area</a>
                                    <a href="charts-chartjs-bar.html" class="dropdown-item">Bar</a>
                                    <a href="charts-chartjs-line.html" class="dropdown-item">Line</a>
                                    <a href="charts-chartjs-other.html" class="dropdown-item">Other</a>
                                </div>
                            </div>
